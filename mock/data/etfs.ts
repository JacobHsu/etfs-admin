...
export const etfs = [
  ...
  { id: 'BOSS', tag: '創始人管理', category: '產業', name: 'Global X Founder-Run Companies ETF', etf: 'BOSS', issuer: 'Global X', index: 'Solactive U.S. Founder-Run Companies Index', star: 3, type: 'ETF' },
  { id: 'BOTZ', tag: '機器人', category: '產業', name: 'Global X Robotics & Artfcl Intllgnc ETF', etf: 'BOTZ', issuer: 'Global X', index: 'Indxx Global Robotics & Artificial Intelligence Thematic Index', star: 0, type: 'ETF' },
  { id: 'BUG', tag: '網路安全', category: '產業', name: 'Global X Cybersecurity ETF', etf: 'BUG', issuer: 'Global X', index: 'Indxx Cybersecurity Index', star: 0, type: 'ETF' },
  { id: 'BUZZ', tag: '網路聲量股', category: '產業', name: 'VanEck Vectors Social Sentiment ETF', etf: 'BUZZ', issuer: 'VanEck', star: 0, type: 'ETF' },
  { id: 'CARZ', tag: '汽車', category: '產業', name: 'First Trust NASDAQ Global Auto Index ETF', etf: 'CARZ', issuer: 'First Trust', star: 2, type: 'ETF' },
  { id: 'CHIC', tag: '中國通訊', category: '產業', name: 'Global X MSCI China Comm Services ETF', etf: 'CHIC', issuer: 'Global X', star: 2, type: 'ETF' },
  { id: 'CLOU', tag: '雲端運算', category: '產業', name: 'Global X Cloud Computing ETF', etf: 'CLOU', issuer: 'Global X', star: 0, type: 'ETF' },
  ...
  { id: 'DRIV', tag: '電動車', category: '產業', name: 'Global X Atnms & Elctrc Vhcls ETF', etf: 'DRIV', issuer: 'Global X', star: 0, type: 'ETF' },
  ...
  { id: 'FILL', tag: '能源生產商', category: '資源', name: 'iShares MSCI Global Energy Producers ETF', etf: 'FILL', issuer: 'iShares', star: 5, type: 'ETF' },
